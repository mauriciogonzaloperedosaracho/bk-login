...
export const typeOrmConfig: TypeOrmModuleOptions = {
  ...
  username: 'postgres',
  password: 'postgres',
  database: 'specialtraining_db',
  entities: [User, Lesion, Tratamientolesion, Gravedadlesion,
  Posiblelesion, Reportarlesion, Jugador, Equipojugador,
  Posicionjugador, Momentolesion, Localizacionlesion, Causalesion],
  synchronize: true,
};
